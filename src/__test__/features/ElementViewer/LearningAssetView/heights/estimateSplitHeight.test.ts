...
import { LEARNING_ASSET_SPLIT_MIN_HEIGHT_IN_PX } from "../../../../../features/ElementViewer/LearningAssetView/learningAssetViewConstants";
import { estimateSplitHeight } from "../../../../../features/ElementViewer/LearningAssetView/heights/estimateSplitHeight";
...
describe("estimateSplitHeight", () => {
	it("Should return the minimum height when the content is empty", () => {
		...
		expect(actual).toBe(LEARNING_ASSET_SPLIT_MIN_HEIGHT_IN_PX);
	});
