...
CREATE TABLE study_profiles(
    ...
    initial_interval_multiplier            REAL        NOT NULL,
...
CREATE TRIGGER study_profiles_update_modified_at_after_update
    AFTER UPDATE OF name, is_default, desired_retention, fsrs_params, initial_interval_multiplier, initial_interval_days, min_interval_days ON study_profiles
BEGIN
...
CREATE TABLE meta(
    ...
    -- When the trash state last changed, including restores (where `trashed_at`
    -- goes back to NULL).
    trash_modified_at   TEXT,
