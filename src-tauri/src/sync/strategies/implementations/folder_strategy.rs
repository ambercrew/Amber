...
pub struct DefaultFolderStrategy {
    folder_repository: Arc<dyn FolderRepository>,
}

#[async_trait]
impl SyncEntityStrategy for DefaultFolderStrategy {
    type Input = generated_code::Folder;
    type Entity = Folder;
...
mod tests {
    ...
    use crate::{
        ...
        generated_code,
        infrastructure::repositories::sqlite::sqlite_folder_repository::SqliteFolderRepository,
        sync::{
            entities::synced_entity::{EntityType, SyncedEntity},
    ...
    -> Arc<dyn SyncEntityStrategy<Input = generated_code::Folder, Entity = Folder>> {
        ...
        injector
            .start_scope()
            .resolve::<dyn SyncEntityStrategy<Input = generated_code::Folder, Entity = Folder>>()
            .await
    }
